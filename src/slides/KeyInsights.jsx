      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-emerald-900">Key Insights</h2>
          </div>
        ...
        <div>
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-emerald-900">Strategic Recommendations</h2>
          </div>

          <div className="grid grid-cols-2 gap-6">
            {recommendations.map((rec, idx) => (
              <div key={idx} className="bg-gradient-to-br from-emerald-700 to-emerald-600 text-offwhite rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow transform hover:scale-105">
        ...
        {/* Bottom Summary */}
        <div className="mt-12 bg-gradient-to-r from-emerald-100 to-emerald-50 rounded-lg p-8 border-2 border-emerald-700">
          <h3 className="text-2xl font-bold text-emerald-900 mb-4">Strategic Direction</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              <div className="w-3 h-3 bg-emerald-700 rounded-full mt-2"></div>
              <span className="text-emerald-800">Institutional ecosystems</span>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-3 h-3 bg-emerald-700 rounded-full mt-2"></div>
              <span className="text-emerald-800">Advisory-based selling</span>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-3 h-3 bg-emerald-700 rounded-full mt-2"></div>
              <span className="text-emerald-800">Demonstration-led awareness</span>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-3 h-3 bg-emerald-700 rounded-full mt-2"></div>
              <span className="text-emerald-800">Export-oriented farming systems</span>
            </div>
          </div>
        </div>
      </div>
